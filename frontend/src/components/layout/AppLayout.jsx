...
<p className="mt-1 font-semibold text-sm text-slate-800 dark:text-slate-200 text-center tracking-tight">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen">
        {/* Top Header Navbar */}
        <header className="h-16 sticky top-0 z-50 bg-white/80 dark:bg-[#242b3d]/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 flex items-center justify-between px-4 sm:px-6 transition-colors duration-300">
          <div className="flex items-center gap-3 min-w-0">
            {canGoBack && (
              <button
                onClick={() => navigate(-1)}
                className="p-2 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-600/55 hover:text-slate-700 dark:hover:text-white transition shrink-0"
                aria-label="Go back"
                title="Go back"
              >
            ...
            <button
              ...
              className="p-2 rounded-xl text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-600/55 transition md:hidden"
          ...
          <div className="flex items-center gap-2.5 sm:gap-3.5 ml-auto">
            ...
            {activeSession && (
              <div
                className="hidden md:flex items-center gap-1.5 rounded-full bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200/70 dark:border-emerald-500/20 px-3 py-1.5 text-[11px] font-semibold text-emerald-700 dark:text-emerald-300"
              ...
              {profileOpen &&
                createPortal(
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2 rounded-xl px-3 py-2 text-xs font-medium text-slate-500 hover:bg-slate-500/10 transition mt-1"
                  >
